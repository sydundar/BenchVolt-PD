...
#define ST7789_RST_PORT   GPIOC // Reset pin port
#define ST7789_RST_PIN    GPIO_PIN_11 // Reset pin number
#define ST7789_DC_PORT    GPIOC // Data/Command pin port
#define ST7789_DC_PIN     GPIO_PIN_10 // Data/Command pin number
#define ST7789_CS_PORT    GPIOD // Chip Select pin port
#define ST7789_CS_PIN     GPIO_PIN_2 // Chip Select pin number
...
/* Basic operations */
// RESET (PC11)
#define ST7789_RST_Set()   (GPIOC->BSRR = GPIO_BSRR_BS_11)
#define ST7789_RST_Clr()   (GPIOC->BSRR = GPIO_BSRR_BR_11)

// DC (PC10)
#define ST7789_DC_Set()    (GPIOC->BSRR = GPIO_BSRR_BS_10)
#define ST7789_DC_Clr()    (GPIOC->BSRR = GPIO_BSRR_BR_10)

#ifndef CFG_NO_CS
#define ST7789_Select()    (GPIOD->BSRR = GPIO_BSRR_BR_2)
#define ST7789_UnSelect()  (GPIOD->BSRR = GPIO_BSRR_BS_2)
#else
...
void ST7789_WriteStringFast(uint16_t x, uint16_t y, const char *str, FontDef font, uint16_t color, uint16_t bgcolor);
