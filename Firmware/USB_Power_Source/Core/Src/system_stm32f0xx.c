...
void SystemInit(void)
{
  ...
  /* Reset SW, HPRE, PPRE, ADCPRE, MCO and MCOPRE bits */
  RCC->CFGR &= (uint32_t)0x08FFB800U;

  /* Reset HSEON, CSSON and PLLON bits */
  RCC->CR &= (uint32_t)0xFEF6FFFFU;

  /* Reset PREDIV1 factor */
  RCC->CFGR2 &= (uint32_t)0xFFFFFFF0U;

  /* Reset USBRESET and SIGN bits */
  RCC->CR2 &= (uint32_t)0xFFFFFFF3U;
